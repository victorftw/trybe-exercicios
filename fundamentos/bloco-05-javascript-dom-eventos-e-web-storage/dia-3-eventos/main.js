...
// com a classe 'tech';
function changeText() {
  const caixaAlterada = document.getElementsByClassName('tech')[0];
  caixaAlterada.innerText = 'Aqui está o texto alterado';
}
...
myWebpage.addEventListener('dblclick', function () {
  window.location.replace('https://victorftw.github.io/');
});
